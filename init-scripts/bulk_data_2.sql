...
CREATE DATABASE IF NOT EXISTS el_escorial CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Asegurar que los usuarios existan y tengan los permisos correctos
...
-- Dar permisos
GRANT ALL PRIVILEGES ON el_escorial.* TO 'administrador'@'%';
GRANT ALL PRIVILEGES ON el_escorial.* TO 'administrador'@'localhost';
...
) ENGINE=MyISAM AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$390000$CmRU7REGWtAjqMkayOvgw8$s8ZS2Nks4BDLfj+s7BUIACwwV2J754ZcNkdyMuZ1JUs=',NULL,1,'admin','','','admin@correo.cl',1,1,'2024-11-12 03:21:08.449464'),(2,'pbkdf2_sha256$390000$G52HZmeuiClyg5jZbpdQny$/NXbr3ibsAqTOuXnLvmdZbTbD38ZcUg48g3shNO8+r8=','2024-11-18 13:27:40.565214',1,'admin_escorial','','','admin_escorial@gmail.com',1,1,'2024-11-13 02:10:15.914894');
...
INSERT INTO `cantidad` VALUES (1,'1','2024-11-13 02:11:32.000000'),(2,'2','2024-11-13 02:11:50.000000'),(3,'3','2024-11-13 02:11:55.000000'),(4,'4','2024-11-13 02:11:57.000000'),(5,'5','2024-11-13 02:11:58.000000');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(2,'auth','permission'),(3,'auth','group'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session'),(7,'tiendaApp','cargo'),(8,'tiendaApp','departamento'),(9,'tiendaApp','empleado'),(10,'tiendaApp','cantidad'),(11,'tiendaApp','repuesto'),(12,'tiendaApp','tipo');
...
-- Dump completed on 2024-11-18 13:31:42
